...
- [Darkmoon](https://github.com/ASCIT31/Dark-Moon) - Self hosted autonomous AI agent that plans and runs penetration tests from the command line and reports proof of exploitation.
