...
- [codeglance](https://github.com/mansoor-mamnoon/codeglance) - Instant codebase orientation: detects framework, run/build/test commands, and key files to read first.
