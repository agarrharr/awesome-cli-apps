...
- [offset](https://github.com/The-Masked-Bear/offset-terminal) - Neubrutalist terminal coding agent with speculative git branching and multi-model orchestration.
