...
- [treepp](https://github.com/Water-Run/treepp) - Modernizes the Windows `tree` command with `.gitignore` support and exclusions, maintaining diff-level compatibility with improved speed.
