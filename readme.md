...
- [lrm](https://github.com/nickprotop/LocalizationManager) - Manage localization files (.resx, JSON, Android, iOS) with validation, translation via local LLMs (Ollama), and code scanning.
