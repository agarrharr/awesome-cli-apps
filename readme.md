...
- [caddy-analyzer](https://github.com/lenny-ts/caddy-analyzer) - Security-focused log analyzer for Caddy v2 with 26 attack categories and real-time iptables blocking.
