...
- [lilbee](https://github.com/tobocop2/lilbee) - Find, run, and manage local AI models, then talk to your files, code, and the sites you crawl, with answers that cite the source, all in one local program.
