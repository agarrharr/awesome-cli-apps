...
- [aicost](https://github.com/dwylq/aicost) - Analyze AI coding assistant costs from local usage logs. Supports Claude Code, Cursor, and GitHub Copilot with cache-aware pricing.
