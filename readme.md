...
- [prerenderbuddy-cli](https://github.com/kopachlager/prerenderbuddy-cli) - Inspect crawler-visible output and compare raw versus rendered HTML for AI/JS SEO checks.
