...
- [harness-audit](https://github.com/sudo-ai-git/harness-audit) - Audit an agent-eval / benchmark-grading workspace for the silent mis-scoring bug class (pytest coverage-gate config leak).
