...
- [bounty-hunter-tools](https://github.com/oc-mm/bounty-hunter-tools) — CLI tool to browse, filter, and analyze open-source bounty opportunities across 13+ platforms.
